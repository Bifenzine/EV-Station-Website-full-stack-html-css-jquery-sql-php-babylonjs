  ...
  <button class="navbar-toggler" type="button" data-bs-toggle="collapse" data-bs-target="#navbarSupportedContent" aria-controls="navbarSupportedContent" aria-expanded="false" aria-label="Toggle navigation">
    ...
    <div class="collapse navbar-collapse allnav" id="navbarSupportedContent">
      ...
      <form class="d-flex spsearch" role="search">
        ...
        <div id="display"></div>
        <button class="btn btn-outline-success form-control-search bi bi-search" type="submit"></i></button>
      </form>
<div>
...
<?php
        ...
        {
          ?>
            <a href="#" class="mx-2" data-bs-toggle="dropdown" aria-expanded="false"><img style="width:40px; color:green;"  src="assets/img/avatar/<?php echo $_SESSION['abonne']['photo']?>" class="photo_profil rounded-circle"/></a>
        ...
        {
          ?>
            <a href="#" class="mx-2" data-bs-toggle="dropdown" aria-expanded="false"><span style="font-size: 30px;" class="bi bi-person"></span></a>
